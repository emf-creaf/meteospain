...
meteorological data and information, being one of their main missions to curate and divulgate data from
meteorlogical stations. `meteospain` only access to the automatic meteorological stations network data.
