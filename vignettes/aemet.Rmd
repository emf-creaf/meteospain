...
[AEMET](http://www.aemet.es/) is the spanish national meteorologic service, and is the national meteorology
...
```{r aemet_key_fake, eval=FALSE}
# get the key we stored before
aemet_key <- keyring::key_get('aemet')
```

```{r aemet_key_real, echo=FALSE, eval=NOT_CRAN}
