...
MeteoGalicia service offers the data of the galician automatic meteorological stations network. This network
is supported and assesed by the Xunta de Galicia and the data should be trustworthy..
...
api_options <- api_options <- meteogalicia_options(
  resolution = 'daily',
