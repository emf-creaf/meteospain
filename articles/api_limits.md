...
#> iterating ■■■                                7% | ETA: 18s
#> 
#> iterating ■■■■■■■■                          22% | ETA: 15s
#> 
#> iterating ■■■■■■■■■■■■                      37% | ETA: 12s
#> 
#> iterating ■■■■■■■■■■■■■■■■■■                56% | ETA:  8s
#> 
#> iterating ■■■■■■■■■■■■■■■■■■■■■■■■■         81% | ETA:  3s
...
#> iterating ■■■                                7% | ETA: 17s
#> 
#> iterating ■■■■■                             15% | ETA: 16s
#> 
#> iterating ■■■■■■■■■■                        30% | ETA: 13s
#> 
#> iterating ■■■■■■■■■■■■■■■                   48% | ETA:  9s
#> 
#> iterating ■■■■■■■■■■■■■■■■■■■■■■            70% | ETA:  5s
...
#> iterating ■■■                                5% | ETA: 23s
#> iterating ■■■■■                             13% | ETA: 20s
#> iterating ■■■■■■■■■                         28% | ETA: 16s
...
#> iterating ■■                                 2% | ETA:  1m
#> iterating ■■■■                              10% | ETA: 46s
#> iterating ■■■■■■                            18% | ETA: 36s
#> iterating ■■■■■■■■■                         25% | ETA: 30s
#> iterating ■■■■■■■■■■■                       35% | ETA: 25s
#> iterating ■■■■■■■■■■■■■■■                   45% | ETA: 20s
#> iterating ■■■■■■■■■■■■■■■■■■                57% | ETA: 14s
#> iterating ■■■■■■■■■■■■■■■■■■■■■■            70% | ETA: 10s
#> iterating ■■■■■■■■■■■■■■■■■■■■■■■■■         80% | ETA:  6s
#> iterating ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■     95% | ETA:  1s
#> iterating ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> ℹ Data provided by meteo.cat © Servei Meteorològic de Catalunya
